...
# 计算二甲苯在指定条件下的生成自由能
print("正在计算二甲苯在温度298K，pH=10，pMg=6条件下的生成自由能...")
xylene_name = "xylene"  # 二甲苯
result = standard_dgf_prime_CC(xylene_name, cc, p_h=10.0, p_mg=6.0, T=298.0)
print(f"二甲苯在指定条件下的生成自由能: {result[0]:.2f} ± {result[1]:.2f} kJ/mol")