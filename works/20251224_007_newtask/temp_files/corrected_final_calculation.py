...
if real_roots:
    ...
    if MoS4_2 != 0:
        ...
        if K1 != 0:
            ...
            print(f'  实际K1 = {calc_K1:.3e}, 给定K1 = {K1:.3e}, 误差 = N/A')
    else:
    ...
    if MoOS3_2 != 0:
        ...
        if K2 != 0:
            ...
            print(f'  实际K2 = {calc_K2:.3e}, 给定K2 = {K2:.3e}, 误差 = N/A')
    else:
    ...
    if MoO2S2_2 != 0:
        ...
        if K3 != 0:
            ...
            print(f'  实际K3 = {calc_K3:.3e}, 给定K3 = {K3:.3e}, 误差 = N/A')
    else:
    ...
    if MoO3S_2 != 0:
        ...
        if K4 != 0:
            ...
            print(f'  实际K4 = {calc_K4:.3e}, 给定K4 = {K4:.3e}, 误差 = N/A')
    else:
